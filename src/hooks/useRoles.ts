...
import rolesService, { type RoleInfoResponse, type RolesScreenInitDto } from '@/services/roles.service';
import type { RoleCreate, RoleUpdate, RoleDetail, RoleSummary } from '@/types/role.types';
